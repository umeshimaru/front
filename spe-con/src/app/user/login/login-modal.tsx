    ...
    <>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="ユーザー名を入力" {...field} className="h-9 sm:h-10 text-sm sm:text-base" />
                </FormControl>
      ...
      <div className="text-center mt-2 pb-6">
        <p className="text-gray-600 text-xs sm:text-sm">
          アカウントをお持ちでないですか？{" "}
          <button onClick={onSwitchToSignup} className="text-[#2d7f98] font-semibold hover:underline">
            新規登録
          </button>
        </p>
      </div>
